	...
	const renderDetailedTable = () => {
		...
		sortedData.forEach((item) => {
			divisionGroups[item.Division] =
				(divisionGroups[item.Division] || 0) + 1;
		});
	...
	const handleSubmit = async (e: React.FormEvent) => {
		...
		try {
			...
			if (reportType === "Summary Report") {
				...
				const cycleTypeParam =
					selectedCycleType === "Bill Cycle" ? "A" : "C";
				const cycleParam =
				...
				<>
                    ...
                    ${
								...
								>
									...
									<option value="Detailed Report">
										Detailed Report
									</option>
									<option value="Summary Report">
										Summary Report
									</option>
								</select>
							</div>
								...
								{reportType === "Summary Report" ? (
									...
									<>
										{selectedCategory === "Entire CEB"
											...
											: `${selectedCategory}: ${categoryValue}`}{" "}
										| {selectedCycleType}: {selectedCycleDisplay} |
										Type: {reportType} | Net Type: {netType}
									</>
								)}
							</p>
						</div>
