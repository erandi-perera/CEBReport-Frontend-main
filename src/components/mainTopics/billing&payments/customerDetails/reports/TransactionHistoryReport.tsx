...
const TransactionHistoryReport = () => {
  ...
  const downloadAsCSV = () => {
    ...
    const csvContent = [
      ...
      "", // Empty line
      // Data section
      `"Bill Month","Year & Month","Days","Units","Transaction Date","Description","Transaction Amount","Balance"`,
    ...
    link.href = url;
    link.download = `TransactionHistory_${data.accountNumber}_${new Date().toISOString().slice(0, 10)}.csv`;
